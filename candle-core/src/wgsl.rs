...
pub const LAYER_NORM: &str = include_str!("../wgsl/layer_norm.wgsl");
pub const LAYER_NORM_F16: &str = include_str!("../wgsl/layer_norm_f16.wgsl");
pub const LAYER_NORM_BF16: &str = include_str!("../wgsl/layer_norm_bf16.wgsl");
...
pub const ROPE_I: &str = include_str!("../wgsl/rope_i.wgsl");
pub const ROPE_I_F16: &str = include_str!("../wgsl/rope_i_f16.wgsl");
pub const ROPE_I_BF16: &str = include_str!("../wgsl/rope_i_bf16.wgsl");
pub const ROPE_THD: &str = include_str!("../wgsl/rope_thd.wgsl");
pub const ROPE_THD_F16: &str = include_str!("../wgsl/rope_thd_f16.wgsl");
pub const ROPE_THD_BF16: &str = include_str!("../wgsl/rope_thd_bf16.wgsl");
pub const ARGSORT: &str = include_str!("../wgsl/argsort.wgsl");
pub const ARGSORT_F16: &str = include_str!("../wgsl/argsort_f16.wgsl");
...
pub const NHWC_TO_NCHW: &str = include_str!("../wgsl/nhwc_to_nchw.wgsl");
pub const NHWC_TO_NCHW_F16: &str = include_str!("../wgsl/nhwc_to_nchw_f16.wgsl");
pub const NHWC_TO_NCHW_BF16: &str = include_str!("../wgsl/nhwc_to_nchw_bf16.wgsl");
...
mod tests {
    ...
    fn shader_sources_contain_entry_points() {
        ...
        assert!(LAYER_NORM.contains("fn layer_norm_f32"));
        assert!(LAYER_NORM_F16.contains("fn layer_norm_f16"));
        assert!(LAYER_NORM_BF16.contains("fn layer_norm_bf16"));
        assert!(ROPE_F16.contains("fn rope_f16"));
        assert!(ROPE_BF16.contains("fn rope_bf16"));
        assert!(ROPE_I.contains("fn rope_i_f32"));
        assert!(ROPE_THD.contains("fn rope_thd_f32"));
        assert!(ARGSORT.contains("fn asort_asc_f32"));
        assert!(ARGSORT_F16.contains("fn asort_asc_f16"));
        assert!(ARGSORT_BF16.contains("fn asort_asc_bf16"));
        assert!(ARGSORT_U32.contains("fn asort_asc_u32"));
