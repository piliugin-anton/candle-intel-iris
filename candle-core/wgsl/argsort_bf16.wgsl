// Bitonic argsort along the last dimension (packed bf16).
...
fn load_f32(row_base: u32, idx: u32) -> f32 {
    let abs_idx = row_base + idx;
    return read_packed_bf16(src_buf[abs_idx / 2u], abs_idx);
}

fn cmp_gt(row_base: u32, ia: u32, ib: u32) -> bool {
    return load_f32(row_base, ia) > load_f32(row_base, ib);
}
